    ...
    <Box>
      ...
      >
        <Box>
          ...
          <Box direction="row">
            <Paragraph>
              This lab is new, so if you see any glitches or have suggestions for edits please email us at <Anchor href="mailto:conservationeducation@sdzwa.org">conservationeducation@sdzwa.org</Anchor>
            </Paragraph>
          </Box>
        </Box>
      </Section>
