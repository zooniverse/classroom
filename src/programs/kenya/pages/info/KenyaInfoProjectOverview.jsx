...
import imgOverview1 from '../../images/overview-1.png';
  ...
  return (
    ...
    >
      ...
      <Box margin={{ bottom: 'medium' }}>
        ...
        <Image className="full-image" src={imgOverview1} size="large" caption="" />
      </Box>
      ...
      <Box margin={{ bottom: 'medium' }}>
        ...
        <Image className="full-image" src={imgOverview3} size="large" caption="" />
      </Box>
      ...
      <Box margin={{ bottom: 'medium' }}>
        ...
        <Image className="full-image" src={imgOverview4} size="large" caption="" />
      </Box>
