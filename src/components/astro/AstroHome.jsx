    ...
    <ProgramHome className="astro-home">
      ...
      {signedIn &&
        ...
        >
          ...
          <Button className="button--secondary" href="https://docs.google.com/document/d/1HOrnvUO-dSMzUsd1IHgx6I_002nYfalaXgSR96_W7Fo/edit" type="button" label="Instructors Guide" target="_blank" rel="noopener noreferrer" />
